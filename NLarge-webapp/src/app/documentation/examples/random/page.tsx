...
const links = [
  ...
  { label: "Example with RNN", link: "#exampleRNN", order: 1 },
  ...
  { label: "Model Training", link: "#exampleRNN_training", order: 2 },
  { label: "Model Evaluation", link: "#exampleRNN_eval", order: 2 },
];
      ...
      <AppShellSection className="flex justify-center pb-10">
        <div className="max-w-screen-lg  w-full flex space-x-8 ml-16">
          <Stack className="w-2/3">
            ...
            <Text c="primary" size="xl" fw="bolder">
              Example of Random Augmentation on RNN
            </Text>
            <div
              id="exampleRNN"
              ref={(el) => {
            ...
            <Text c="dimmed" size="md">
              ...
              will be evaluating augmented datasets on RNN based on the loss and
              accuracy metrics. We have chosen the 'rotten tomatoes' dataset due
              to it's small size that is prone to overfitting.
            </Text>
            <Text c="primary" size="lg" fw="bolder">
              Importing libraries:
            </Text>
...
augmented_train_data_100 = concatenate_datasets(
    [original_train_data, augmented_dataset_100]
            ...
            <Text c="primary" size="lg" fw="bolder">
              Loading the pipeline & model training
            </Text>
            <div
            ...
            />
            <Text c="dimmed" size="md">
              Here, we will initialize the pipeline with the augmented datasets
